...
// - changed firstTokenId, secondTokenId, nonExistentTokenId to be valid Plus Code token IDs which have a parent
// - renamed one test token ID, see https://github.com/OpenZeppelin/openzeppelin-contracts/pull/2801/files
// - commented out one test, see https://github.com/OpenZeppelin/openzeppelin-contracts/issues/2804
...
const firstTokenId = new BN('34343434303030302B', 16);
const secondTokenId = new BN('35353535353535352B', 16);
const nonExistentTokenId = new BN('33333333303030302B', 16);
const fourthTokenId = new BN('33333333353232352B', 16);
